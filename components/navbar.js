...
`;
  ...
  return (
<>
    <div className={"top-0 flex justify-between py-2  md:px-3 md:pb-3 LibreBaskerville text-lg border-b border-black sticky z-40 textDecorationNone " + stick} style={style} >
